...
from lib.diffusion_model.unet import ScaleAt
from lib.diffusion_model.latentnet import *
from lib.diffusion.resample import UniformSampler
from lib.diffusion.diffusion import space_timesteps
from typing import Tuple

from torch.utils.data import DataLoader

from lib.config_base import BaseConfig
from lib.dataset import *
from lib.diffusion import *
from lib.diffusion.base import GenerativeType, LossType, ModelMeanType, ModelVarType, get_named_beta_schedule
from lib.diffusion_model import *
from lib.choices import *
from multiprocessing import get_context
import os
from lib.dataset_util import *
...
class TrainConfig(BaseConfig):
    ...
    eval_path: str = None
    base_dir: str = os.path.join("models", "pretrained", "diffusion_model")
